...
{
    internal class BrowserModListItem_Overlay : MonoBehaviour, IPointerExitHandler
    {
        ...
        public BrowserModListItem listItemToReplicate;
        public BrowserModListItem lastListItemToReplicate;
        ...
        public void Setup(BrowserModListItem listItem)
        {
