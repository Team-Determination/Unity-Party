...
namespace ModIO.Implementation.Platform
{
    ...
    {
        /// <summary>FileStream implementation.</summary>
...
#region Properties
        ...
        {
            get => this.fileStream.ReadTimeout;
            set => this.fileStream.ReadTimeout = value;
        }
        ...
        {
            get => this.fileStream.WriteTimeout;
            set => this.fileStream.WriteTimeout = value;
        }

        /// <summary>Gets the absolute path of the file opened in the stream.</summary>
        public override string FilePath => this.fileStream.Name;
...
#region Initialization
        ...
        // /// </summary>
        // public FileStreamWrapper(IDataService dataService, string filePath, bool
        // enableExceptions)
        // {
        ...
        /// Initializes the FileStream with the given file path using the given service.
        /// </summary>
        public FileStreamWrapper(System.IO.FileStream internalStream)
        {
            this.fileStream = internalStream;
        }
...
#region System.IO.Stream Interface
        ...
        {
            return this.fileStream.InitializeLifetimeService();
        }
        ...
        public override async Task<ResultAnd<byte[]>> ReadAllBytesAsync()
        {
            ...
            if(SystemIOWrapper.IsPathValid(this.fileStream.Name, out result)
               && SystemIOWrapper.DoesFileExist(this.fileStream.Name, out result))
            {
                try
                {
        ...
        public override async Task<Result> WriteAllBytesAsync(byte[] buffer)
        {
            ...
            if(SystemIOWrapper.IsPathValid(this.fileStream.Name, out result)
               && SystemIOWrapper.TryCreateParentDirectory(this.fileStream.Name, out result))
            {
                try
                {
            ...
            Logger.Log(LogLevel.Verbose,
                       $"Write file: {this.fileStream.Name} - Result: [{result.code}]");
...
#region Object Interface
        ...
        {
            return this.fileStream.Equals(obj);
        }

        public override int GetHashCode()
        {
            return this.fileStream.GetHashCode();
        }
...
#pragma warning disable 0809 // Warning: override non-obsolete function with obsolete
#region Obsolete
                                               ...
                                               AsyncCallback callback, object state)
        {
            ...
            return this.fileStream.BeginRead(buffer, offset, count, callback, state);
        }
                                                ...
                                                AsyncCallback callback, object state)
        {
            ...
            return this.fileStream.BeginWrite(buffer, offset, count, callback, state);
        }
...
#endregion // Obsolete
#pragma warning restore 0809 // Warning: override non-obsolete function with obsolete
    }
}
